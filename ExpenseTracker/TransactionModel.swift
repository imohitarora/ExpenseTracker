...
extension Category {
    ...
    static let feesAndCharges = Category(id: 4, name: "Fees & Charges", icon: .credit_card)
    ...
    static let bankFee = Category(id: 401, name: "Bank Fee", icon: .credit_card, mainCategoryId: 4)
    ...
    static let homeSupplies = Category(id: 602, name: "Home Supplies", icon: .home, mainCategoryId: 6)
